    ...
    <div className="max-w-xl mx-auto animate-fade-in"><div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl overflow-hidden">
      ...
      <div className="p-6 md:p-8">
        ...
        {step === 3 && (<div className="space-y-4 animate-fade-in">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-[var(--border)]"><span className="text-xs text-[var(--text-secondary)]">Total</span><span className="mono text-sm font-semibold">{totalAmount.toFixed(2)} USDT0</span></div>
        ...
        {step === 4 && (<div className="space-y-4 animate-fade-in">
          <div className="bg-[var(--bg)] rounded-lg border border-[var(--border)] divide-y divide-[var(--border)]">
            ...
            <div className="p-4"><span className="text-[10px] uppercase tracking-wider text-[var(--text-tertiary)]">Milestones</span><div className="mt-2 space-y-1.5">{milestones.map((m,i) => (<div key={i} className="flex items-center justify-between text-sm"><span className="text-[var(--text-secondary)]">{m.description}</span><span className="mono font-medium">{m.amount} USDT0</span></div>))}</div><div className="flex items-center justify-between mt-3 pt-3 border-t border-[var(--border)]"><span className="text-xs font-medium">Total</span><span className="mono text-sm font-bold">{totalAmount.toFixed(2)} USDT0</span></div></div>
          </div>
          <div className="flex items-center gap-2 px-3 py-2.5 bg-[var(--success-subtle)] rounded-lg"><div className="w-1.5 h-1.5 rounded-full bg-[var(--success)]" /><span className="text-xs text-[var(--success)]">Transaction fees are near-zero on Conflux (less than $0.001)</span></div>
